    ...
    <style>
        ...
        * {
        ...
        .nav-badge {
            ...
            border-radius: 20px;
            line-height: 1.4;
            border: 1px solid rgba(52, 168, 140, .3);
        }
        ...
        .sidebar-toggle {
            ...
            border: 1.5px solid rgba(52, 168, 140, .15);
            display: flex;
            align-items: center;
            justify-content: center;
            cursor: pointer;
        ...
        .header-clock {
            ...
            padding: 0 8px;
            border-right: 1px solid rgba(52, 168, 140, .12);
            margin-right: 8px;
            padding-right: 20px;
        }
        ...
        .kbd {
            ...
            background: #fff;
            color: var(--muted);
            border: 1px solid rgba(52, 168, 140, .2);
            white-space: nowrap;
        }
        ...
        .stat-card:hover {
            ...
            box-shadow: var(--shadow-lg);
            border-color: rgba(52, 168, 140, .25);
        }
        ...
        .stat-icon.teal {
            background: linear-gradient(135deg, rgba(52, 168, 140, .18), rgba(52, 168, 140, .08));
            color: var(--teal-500);
        }
        ...
        .btn-primary {
            ...
            color: #fff;
            box-shadow: 0 3px 10px rgba(52, 168, 140, .35);
        }

        .btn-primary:hover {
            transform: translateY(-1px);
            box-shadow: 0 6px 18px rgba(52, 168, 140, .45);
        }
        ...
        thead tr {
            background: linear-gradient(to bottom, var(--teal-50), #fff 150%);
        }
        ...
        .chart-legend {
            ...
            margin-top: 12px;
            padding-top: 12px;
            border-top: 1px dashed rgba(52, 168, 140, .15);
        }
        ...
        .queue-item {
            ...
            gap: 12px;
            padding: 14px 18px;
            border-bottom: 1px solid rgba(52, 168, 140, .06);
            transition: background .15s;
            cursor: pointer;
        }
        ...
        @keyframes pulse-ring {
            0% {
                box-shadow: 0 2px 6px rgba(16, 185, 129, .4), 0 0 0 0 rgba(16, 185, 129, .4);
            }

            70% {
                box-shadow: 0 2px 6px rgba(16, 185, 129, .4), 0 0 0 8px rgba(16, 185, 129, 0);
            }

            100% {
                box-shadow: 0 2px 6px rgba(16, 185, 129, .4), 0 0 0 0 rgba(16, 185, 129, 0);
            }
        }
        ...
        .tabs {
            ...
            padding: 4px;
            border-radius: 10px;
            border: 1px solid rgba(52, 168, 140, .12);
        }
        ...
        .tab.active {
            background: #fff;
            color: var(--teal-700);
            box-shadow: 0 1px 4px rgba(20, 90, 75, .08);
        }
        ...
        .pagination {
            ...
            justify-content: space-between;
            padding: 14px 22px;
            border-top: 1px solid rgba(52, 168, 140, .08);
        }
        ...
        .page-btn.active {
            ...
            color: #fff;
            border-color: var(--teal-400);
            box-shadow: 0 2px 8px rgba(52, 168, 140, .3);
        }
        ...
        .toast.closing {
            animation: slideOutRight .25s forwards;
        }
        ...
        .form-textarea {
            padding: 11px 14px;
            border: 1.5px solid rgba(52, 168, 140, .18);
            border-radius: 10px;
            background: #fff;
            font-family: inherit;
            font-size: 14px;
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('dashboard.show') }}" class="nav-item {{ request()->routeIs('dashboard*') ? 'active' : '' }}">
            ...
            <a href="{{ route('fileAttente.index') }}" class="nav-item {{ request()->routeIs('queue*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
