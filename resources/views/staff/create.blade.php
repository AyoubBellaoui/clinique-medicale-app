...
@php
    // Determine which section to re-open after validation failure
    $openSection = 1;
    ...
    // Section 1 errors always override (highest priority to show first)
...
<form action="{{ route('staff.store') }}" method="POST" id="staffForm" novalidate>
    @csrf
                    ...
                    <div style="padding:24px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        ...
                        <div style="grid-column:1/-1;padding:16px;border-radius:12px;background:rgba(52,168,140,.04);border:1.5px dashed rgba(52,168,140,.2);">
                            ...
                            <div style="display:flex;gap:8px;align-items:center;">
                                ...
                                <label style="cursor:pointer;">
                                    <input type="radio" name="color" value="{{ $cname }}" {{ (old('color','teal')===$cname) ? 'checked' : '' }} style="display:none;" onchange="updatePreviewColor('{{ $cname }}','{{ $chex }}')">
                                    <div class="color-dot" data-color="{{ $cname }}" style="width:32px;height:32px;border-radius:50%;background:{{ $chex }};cursor:pointer;border:3px solid {{ (old('color','teal')===$cname) ? 'white' : 'transparent' }};box-shadow:{{ (old('color','teal')===$cname) ? '0 0 0 2px '.$chex.', 0 3px 8px rgba(0,0,0,.15)' : '0 2px 6px rgba(0,0,0,.1)' }};transition:all .2s;display:flex;align-items:center;justify-content:center;">
                                        @if(old('color','teal')===$cname)
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text" class="form-control pf-input @error('cin') input-error @enderror" name="cin" placeholder="CIN" value="{{ old('cin') }}" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                <svg style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--muted);pointer-events:none;" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>
                                <input type="text" class="form-control pf-input @error('prenom') input-error @enderror" name="prenom" id="first_name" placeholder="Prénom" value="{{ old('prenom') }}" oninput="updatePreview()" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                <svg style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--muted);pointer-events:none;" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>
                                <input type="text" class="form-control pf-input @error('nom') input-error @enderror" name="nom" id="last_name" placeholder="Nom de famille" value="{{ old('nom') }}" oninput="updatePreview()" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="email" class="form-control pf-input @error('email') input-error @enderror" name="email" id="email_field" placeholder="prenom.nom@clinique.ma" value="{{ old('email') }}" oninput="updatePreview()" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <input type="hidden" name="gender" id="gender_input" value="{{ old('gender') }}">
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text" class="form-control pf-input" name="adresse" placeholder="Adresse complète" value="{{ old('adresse') }}" style="padding-left:36px;">
                            </div>
                        </div>
                ...
                <div class="card" style="margin-bottom:16px;overflow:hidden;">
                    ...
                    <div style="padding:24px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <input type="hidden" name="role" id="role_input" value="{{ old('role') }}">
                        ...
                        <div class="form-group" style="margin-bottom:0;" id="specialty-wrap">
                            ...
                            <div style="position:relative;">
                                ...
                                <select class="form-control form-select pf-input @error('specialite') input-error @enderror" name="specialite" id="specialty_field" onchange="updatePreview()" style="padding-left:36px;">
                                    ...
                                    <option {{ old('specialite')===$spec ? 'selected' : '' }}>{{ $spec }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text" class="form-control pf-input @error('license_number') input-error @enderror" name="license_number" id="license_field" placeholder="Numéro d'inscription" value="{{ old('license_number') }}" oninput="updatePreview()" style="padding-left:36px;letter-spacing:.04em;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text" class="form-control pf-input @error('degree') input-error @enderror" name="degree" placeholder="Ex: Doctorat en Médecine" value="{{ old('degree') }}" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="text" class="form-control pf-input @error('school') input-error @enderror" name="school" placeholder="Ex: Faculté de Médecine de Casablanca" value="{{ old('school') }}" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                <svg style="position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--muted);pointer-events:none;" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25" /></svg>
                                <input type="number" class="form-control pf-input @error('grad_year') input-error @enderror" name="grad_year" placeholder="Ex: 2015" min="1970" max="2030" value="{{ old('grad_year') }}" style="padding-left:36px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <input type="hidden" name="languages" id="lang_input" value="{{ old('languages') }}">
                ...
                <div class="card" style="margin-bottom:16px;overflow:hidden;">
                    ...
                    <div style="padding:24px;display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <input type="hidden" name="contract_type" id="contract_input" value="{{ old('contract_type') }}">
                            <div style="display:flex;flex-wrap:wrap;gap:8px;">
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <div style="position:relative;">
                                ...
                                <input type="number" class="form-control @error('salaire') input-error @enderror" name="salaire" placeholder="Ex: 15 000" min="0" value="{{ old('salaire') }}" style="padding-left:40px;">
                            </div>
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <input type="hidden" name="schedule" id="schedule_input" value="{{ old('schedule') }}">
                            <div style="display:flex;flex-wrap:wrap;gap:8px;">
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <input type="hidden" name="status" id="status_input" value="{{ old('status', 'actif') }}">
                        ...
                        <div class="form-group" style="margin-bottom:0;grid-column:1/-1;">
                            ...
                            <textarea class="form-control @error('notes') input-error @enderror" name="notes" rows="3" placeholder="Informations complémentaires sur le membre du personnel…" style="resize:vertical;line-height:1.6;">{{ old('notes') }}</textarea>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    oldLangs.forEach(l => {
        ...
        selectedLangs.add(trimmed);
        document.querySelectorAll('.lang-btn').forEach(b => {
            if (b.dataset.lang === trimmed) b.classList.add('active');
        });
    });
    ...
    if (oldColor && colorHexMap[oldColor]) {
        updatePreviewColor(oldColor, colorHexMap[oldColor]);
    }
});
